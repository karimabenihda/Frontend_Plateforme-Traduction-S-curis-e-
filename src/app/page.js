...
function page() {
    ...
    const openMenuHandler = () => {
        // navLinks.classNameList.remove("-translate-x-full")
        // navLinks.classNameList.add("translate-x-0")
    }

    const closeMenuHandler = () => {
        // navLinks.classNameList.remove("translate-x-0")
        // navLinks.classNameList.add("-translate-x-full")
    }
...
<section className="flex flex-col items-center text-sm bg-[url('https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/bg-with-grid.png')] bg-cover bg-center bg-no-repeat">
    ...
    />
        ...
        <div className=" md:block space-x-3">
            <a href="login" className="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 transition text-white rounded-md">
                Login
            </a>
            <a href="/register" className="hover:bg-slate-100 transition px-6 py-2 border border-indigo-600 rounded-md">
               Register
            </a>
        </div>
...
La Traduction Instantanée, Sécurisée et Propulsée par l’IA        </h1>
        <p className="text-center text-base text-slate-700 max-w-lg mt-2">
Nous avons construit une application web fullstack sécurisée qui transforme la manière dont les équipes traduisent leurs contenus. Grâce à l’intégration directe de l’API Hugging Face Inference, notre plateforme utilise des modèles avancés tels que Helsinki-NLP/opus-mt-fr-en et opus-mt-en-fr pour offrir une traduction rapide, fiable et de haute qualité entre le français et l’anglais.  </p>

        <div className="flex items-center gap-4 mt-8">
            <a href="/register" className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white active:scale-95 rounded-lg px-7 h-11">
                Get started
...
<section className="!mt-12  bg-[#ffff] flex flex-col md:flex-row items-center justify-center gap-10 max-md:px-4">
                <div className="relative shadow-2xl shadow-indigo-600/40 rounded-2xl overflow-hidden shrink-0">
                    ...
                    <div className="flex items-center gap-1 max-w-72 absolute bottom-8 left-8 bg-white p-4 rounded-xl">
                        ...
                        <p className="text-sm font-medium text-slate-800">Join our  community</p>
                    </div>
                </div>
                <div className="text-sm text-slate-600 max-w-lg">
                    <h1 className="text-xl uppercase font-semibold text-slate-700">👉 Comment ça marche ?</h1>
                    <div className="w-24 h-[3px] rounded-full bg-gradient-to-r from-indigo-600 to-[#DDD9FF]"></div>
                    <p className="mt-8">L'utilisateur authentifié envoie un texte en FR ou EN.</p>
                    <p className="mt-4">Le backend sécurisé transmet la requête au modèle IA.</p>
                    <p className="mt-4">L’IA génère la traduction instantanément.</p>
                    <p className="mt-4">Le système renvoie un JSON propre et structuré au frontend.</p>
...
<section>
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 pt-12">
                <div className="max-w-72 w-full hover:-translate-y-0.5 transition duration-300">
                    ...
                    <h3 className="text-base text-slate-900 font-medium mt-3">🔐 Sécurisé de bout en bout, notre service repose sur un backend API robuste, protégé par authentification JWT, garantissant que seules les personnes autorisées peuvent utiliser la plateforme.</h3>
                    <p className="text-xs text-indigo-600 font-medium mt-1">Sécurité</p>
                </div>
                <div className="max-w-72 w-full hover:-translate-y-0.5 transition duration-300">
                    ...
                    <h3 className="text-base text-slate-900 font-medium mt-3">🚀 Une solution moderne, rapide et scalable, pensée pour les entreprises qui veulent traduire intelligemment, sans complexité technique et sans entraîner leurs propres modèles.</h3>
                    <p className="text-xs text-indigo-600 font-medium mt-1">Innovation</p>
                </div>
...
<footer className="flex flex-col items-center justify-around w-full py-16 text-sm bg-slate-50 text-gray-800/70">
               ...
               {/* <div>translation</div>  */}
                <p className="mt-4 text-center">Copyright © 2025 <a href="https://prebuiltui.com">TranslaAI</a>. All rights reservered.</p>
